...
public class BinaryTree {
    ...
    private BinaryNode findParent(BinaryNode curr, Object parentValue) {
        ...
        if (curr == null) {
        	...
        	BinaryNode left = findParent(curr.left, parentValue);
        	if (left != null)
        		return left;
        	
        	BinaryNode right = findParent(curr.right, parentValue);
        	if(right!=null)
        		return right;
    ...
    private String toString(BinaryNode curr) {
    	...
    	return "("+ curr.value.toString() + " " + this.toString(curr.left) + " "+ this.toString(curr.right)+ ")";
